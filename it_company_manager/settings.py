"""
Django settings for it_company_manager project.
...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY",'django-insecure-lz4gqbazmbi!1k0m2gqt&!)5(g0l7nf5vfr7=@r_dt1^9wauva')
